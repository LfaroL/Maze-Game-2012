...
namespace MazeProject
{
    ...
    {
        // creates instance of LevelFive
        private static readonly LevelFive LvLFive = new LevelFive();
        // let's other forms use LevelFive instance
        public static LevelFive LevelFiveInstance
        {
            get { return LvLFive; }
        }
        ...
        private void reset()
        {
            ...
            charLabel.Location = new Point(150, 160);
            box1.Location = new Point(270, 360);
            box2.Location = new Point(150, 320);
            box3.Location = new Point(190, 200);
            block.Visible = true;
            block.Location = new Point(150, 120);
        }
        ...
        private void LevelFive_Load(object sender, EventArgs e)
        {
            PicArray();
            PicArray2();
            PicArray3();
        ...
        private void LevelFive_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
