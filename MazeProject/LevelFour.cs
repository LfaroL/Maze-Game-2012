...
namespace MazeProject
{
    ...
    {
        // creates instance of LevelFour
        private static readonly LevelFour LvLFour = new LevelFour();
        // let's other forms use LevelFour instance
        public static LevelFour LevelFourInstance
        {
            get { return LvLFour; }
        }
        ...
        private void reset()
        {
            ...
            charLabel.Location = new Point(100, 150);
            box1.Location = new Point(180, 230);
            box2.Location = new Point(140, 150);
            box3.Location = new Point(140, 270);
            box4.Location = new Point(140, 190);
            block.Visible = true;
            block.Location = new Point(220, 150);
        }

        private void LevelFour_Load(object sender, EventArgs e)
        {
            PicArray();
            PicArray2();
            PicArray3();
        ...
        private void LevelFour_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
