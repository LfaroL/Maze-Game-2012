...
namespace MazeProject
{
    ...
    {
        // creates instance of LevelOne
        private static readonly LevelOne LvLOne = new LevelOne();
        // let's other forms use LevelOne instance
        public static LevelOne LevelOneInstance
        {
            get { return LvLOne; }
        }
        public LevelOne()
        ...
        private void reset()
        {
            ...
            charLabel.Location = new Point(190, 175);
            box1.Location = new Point(150, 175);
            box2.Location = new Point(230, 135);
            box3.Location = new Point(150, 135);
            block.Visible = true;
            block.Location = new Point(230, 415);
        }
        ...
        private void LevelOne_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
